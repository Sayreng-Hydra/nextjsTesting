...
import ProjectImage from '../public/ramon-salinero-vEE00Hx5d0Q-unsplash.jpg';

const DataAnalysis: NextPage = () => {
	return (
		<div>
			<h1 className="text-xl text-indigo-600 mb-4 font-bold">Electrolysis monitoring program</h1>
